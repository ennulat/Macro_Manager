...
{
    class c_BranchenbuchSuche : BusinessDirectory
    {

        public c_BranchenbuchSuche(Customer customer): base(customer)//second param iiOpenMode
        {
            BusinessDirectory.directoryname = "BranchenbuchSuche";
        ...
        protected override void setFinalMacroSuccessStatus(string macroType)
        {
            ...
            switch (macroType)
            {
                case "entry": base.finalSuccessStatus = "Eintrag-Hinzufuegen-Kostenlos-Schritt3"; break;
        ...
        protected override void setiiPlayListEntry() {
            ...
            base.macroParts.Add(Config.macroPath + "BranchenbuchSuche\\BranchenbuchSuche.iim");
