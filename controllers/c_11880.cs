...
{
    class c_11880 : BusinessDirectory
    {
        
        public c_11880(Customer customer): base(customer)//second param iiOpenMode
        {
            BusinessDirectory.directoryname = "11880";
        ...
        protected override void setiiPlayListEntry() {
            ...
            base.macroParts.Add(Config.macroPath + "11880\\11880_complete.iim");
