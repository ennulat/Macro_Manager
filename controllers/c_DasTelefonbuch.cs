...
{
    class c_DasTelefonbuch : BusinessDirectory
    {

        public c_DasTelefonbuch(Customer customer): base(customer)
        {
        ...
        {
            string iiLogoPlaycodestr = "CODE: PROMPT 1.)Upload<SP>Firmenlogo<BR>2.)Macro<SP>fortführen...\nPAUSE\n";
        ...
        {
            string iiGallerypcisPlaycodestr = "CODE: PROMPT 1.)Upload<SP>Gallery<SP>Bild(er)<BR>2.)Macro<SP>fortführen...\nPAUSE\n";
        ...
        protected override void setiiOpeningHoursCodePlayEntry()
        {
            ...
            //}
            iiohPlaycodestr += "TAG POS=1 TYPE=TEXTAREA ATTR=ID:openingHoursExtra CONTENT="+base.csvVars["COL22"].ToString().Replace(" ","<SP>")+"\n";
        ...
        protected override string getiiOpeningHoursWeekdayStringEntry(string day, string mode, string times)
        {
            ...
            switch (mode)
            {
                ...
                case "24h":
                    ...
                    iiohPlaycodestr += "TAG POS=1 TYPE=SELECT  ATTR=ID:timeselect_from_1 CONTENT=%00:00\n";
                    iiohPlaycodestr += "TAG POS=1 TYPE=SELECT  ATTR=ID:timeselect_to_1 CONTENT=%00:00\n";
                    break;
                case "open":
                    string[] openingtimes = times.Split('-');
                    iiohPlaycodestr += "TAG POS=1 TYPE=SELECT  ATTR=ID:timeselect_from_1 CONTENT=%" + openingtimes[0] + "\n";
                    iiohPlaycodestr += "TAG POS=1 TYPE=SELECT  ATTR=ID:timeselect_to_1 CONTENT=%" + openingtimes[1] + "\n";
                    break;
                case "split":
                    ...
                    iiohPlaycodestr += "TAG POS=1 TYPE=SELECT  ATTR=ID:timeselect_from_1 CONTENT=%" + fntimeFrom + "\n";
                    iiohPlaycodestr += "TAG POS=1 TYPE=SELECT  ATTR=ID:timeselect_to_1 CONTENT=%" + fntimeTo + "\n";
                    iiohPlaycodestr += "TAG POS=1 TYPE=SELECT  ATTR=ID:timeselect_from_2 CONTENT=%" + antimeFrom + "\n";
                    iiohPlaycodestr += "TAG POS=1 TYPE=SELECT  ATTR=ID:timeselect_to_2 CONTENT=%" + antimeTo + "\n";
                    break;
            }
