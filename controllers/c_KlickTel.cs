...
{
    class c_KlickTel : BusinessDirectory
    {
        
        public c_KlickTel(Customer customer): base(customer)//second param iiOpenMode
        {
            BusinessDirectory.directoryname = "KlickTel";
        ...
        protected override void setFinalMacroSuccessStatus(string macroType)
        {
            ...
            switch (macroType)
            {
                case "entry": base.finalSuccessStatus = "Vielen Dank für die Buchung"; break;
        ...
        protected override void setiiPlayListEntry() {
            ...
            base.macroParts.Add(Config.macroPath + "KlickTel\\KlickTel_complete.iim");
